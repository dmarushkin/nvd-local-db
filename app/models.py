...
class Vulnerability(Base):
    ...
    cpe = Column(ARRAY(String), nullable=True)
    ...
    cisaExploitAdd = Column(String, nullable=True)
    cisaRequiredAction = Column(String, nullable=True)
    cisaActionDue = Column(String, nullable=True)
